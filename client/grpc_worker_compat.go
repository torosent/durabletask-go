...
func (c *TaskHubGrpcClient) StartWorkItemListener(ctx context.Context, registry *task.TaskRegistry) error {
	c.listenerMu.Lock()
	...
	worker, err := NewTaskHubGrpcWorker(c.connection, registry, c.logger)
	if err != nil {
