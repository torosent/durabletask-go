...
- Activity and sub-orchestration retry options snapshot and normalize caller policies without mutation, and no retry timer is scheduled beyond `RetryTimeout`.
